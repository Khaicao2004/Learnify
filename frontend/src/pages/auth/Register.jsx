...
const Register = () => {
    const handleSubmit = (e) => {
        e.preventDefault();
        axiosInstance.post('register', {"name": "khaicq"})
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input type="text" name="email" id="email" placeholder="Enter email" className="w-full px-4 py-3 border border-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" />
                    </div>
                    <div>
                        <label htmlFor="password" className="block text-sm font-medium text-gray-700 mb-2">Password</label>
                        <input type="password" name="password" id="password" placeholder="Enter password" className="w-full px-4 py-3 border border-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" />
                    </div>
                    <div>
